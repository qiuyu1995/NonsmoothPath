---
title: "Using the pathNonsmooth package"
author: "Qiuyu Gu"
date: "`r Sys.Date()`"
...
The `pathNonsmooth` package contains the implementation of the path-following algorithm to solve case weight adjusted problem
\begin{equation}
...
## Using `pathNonsmooth` functions
For each given data and specified model, function `nonsmooth_path` in `pathNonsmooth` package computes solution path of \eqref{eq:case_weight_adjusted_setup} and outputs the
